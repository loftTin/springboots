...
~~~~xml
 <select id="selectAllRouterMenu" resultType="com.sangeng.domain.com_bjut.blog.domain.com_bjut.blog.domain.entity.Menu">
        SELECT
    ...
    <select id="selectRouterMenuTreeByUserId" resultType="com.sangeng.domain.com_bjut.blog.domain.com_bjut.blog.domain.entity.Menu">
        SELECT
          DISTINCT m.id, m.parent_id, m.menu_name, m.path, m.component, m.visible, m.status, IFNULL(m.perms,'') AS perms, m.is_frame,  m.menu_type, m.icon, m.order_num, m.create_time
        FROM
            `sys_user_role` ur
